              ...
              const Padding(
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    SizedBox(height: 8),
                    Text('Enter your email and password', style: TextStyle(color: Colors.white70)),
                  ],
                ),
              ),
              Expanded(
                            ...
                            children: [
                              Expanded(
                                child: TextButton(
                                  ...
                                  child: Text('Log In', style: TextStyle(color: isLogin ? Colors.white : Colors.black)),
                                ),
                              ),
                              Expanded(
                                child: TextButton(
                                  ...
                                  child: Text('Sign Up', style: TextStyle(color: !isLogin ? Colors.white : Colors.black)),
                                ),
                              ),
                            ],
                          ),
